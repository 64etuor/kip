...
from kip.database_port import evaluate_database_port, project_root_from_env
...
from kip.domain.ontology_migration import validate_migration_coverage
...
from kip.ontology_migration import diff_ontologies, load_migration
...
def doctor(ctx: typer.Context) -> None:
    ...
    _run(
        ctx,
        lambda runtime: runtime.container.application.diagnostics.collect_doctor_report(
            runtime.context
        ),
    )
...
def ontology_validate(
    ...
    def action(runtime: Runtime) -> Any:
        ...
        catalog = load_catalog(root_path, domain_profile=domain_profile)
        return {
